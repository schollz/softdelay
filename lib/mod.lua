...
mod.hook.register("system_post_startup","softdelay-poststartup",function()
  state.system_post_startup=true
end)

mod.hook.register("script_pre_init","softdelay-preinit",function()
  -- tweak global environment here ahead of the script `init()` function being called
  local softdelay_=include("softdelay/lib/softdelay")
  softdelay=softdelay_:new()
end)
